...
const NutritionSection = () => {
  ...
  return (
    <section className="nutrition-section">
        <img src="images/slider-dip.png" alt="slider-img" 
            className="w-full object-cover"
        />
        <img src="images/big-img.png" alt="big-img" 
            className="big-img"
        />
            ...
            <div className="relative inline-block md:translate-y-20">
                <div className="general-title relative flex flex-col items-center gap-24">
                    <div className="overflow-hidden place-self-start">
                        <h1 className="nutrition-title">It Still Fuels</h1>
                    </div>
                    ...
                    >
                        <div className="bg-yellow-brown pb-5 md:pt-0 pt-3 md:px-5 px-3 inline-block">
                            <h2 className="text-milk-yellow">Your Fire</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="list-wrapper">
                    {list.map((val, index) => (
                            <div key={index} className="relative flex-1 col-center">
                                <div>
                                    <p className="md:text-lg font-paragraph">{val.label}</p>
                                    <p className="font-paragraph text-sm mt-2">up to</p>
                                    <p className="text-2xl md:text-4xl tracking-tighter font-bold">{val.amount}</p>
                                </div>
